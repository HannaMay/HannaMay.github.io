...
var knowledge = [
    ...
    [ "уровни в игре", "разделяются", " на типы планет: <ul><li>Планета снега,</li><li>Планета пустыни и солнца,</li><li>Планета зелёного леса</li></ul>" ],
		...
		[ "в игре есть кристаллы с водой, их необходимо", "собрать", "для полива Розы и пройти всю планету" ],
		//как можно выйграть
		...
		//Как пройти обучение
		[ "обучение можно", "пройти", "выбрав в меню панету c названием - обучение"],
		//какой конец в игре
		[ "конец игры", "- это", "открытая концовка,  так как для развития полного сюжета, лисёнок должен поситить все планты на которых был Маенький принц" ],
		//кто автор оргинальной истории
		[ "Автором оргинальной истории", "является", "Антуан де Сент-Экзюпери" ],
		//
		[ "", "", "" ],
		//
		[ "", "", "" ],
